...
import 'package:surf_flutter_winter_internship_2025/presentation/screens/sort/sort_screen.dart';
import 'package:surf_flutter_winter_internship_2025/presentation/screens/sort/view_model/i_sort_screen_vm.dart';
import 'package:surf_flutter_winter_internship_2025/presentation/screens/sort/view_model/sort_screen_vm.dart';
...
class SortScreenBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ISortScreenVM>(
      create: (context) => SortScreenVM(onApply: onApply, initialSort: initialSort, initialFilters: initialFilters),
